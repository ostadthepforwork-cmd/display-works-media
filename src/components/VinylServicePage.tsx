...
const sizes = [
  { w: "1", h: "2", label: "1 × 2 เมตร", use: "ป้ายหน้าร้าน ป้ายโปรไมล์ขนาดเล็ก", popular: false },
  { w: "1.5", h: "3", label: "1.5 × 3 เมตร", use: "เหมาะสำหรับหน้าร้านอาหาร พาณิชย์", popular: true },
  { w: "2", h: "4", label: "2 × 4 เมตร", use: "เหมาะสำหรับป้ายโฆษณาขนาดกลาง", popular: false },
  { w: "3", h: "6", label: "3 × 6 เมตร", use: "เหมาะสำหรับป้ายโฆษณาขนาดใหญ่", popular: false },
  { w: "4", h: "8", label: "4 × 8 เมตร", use: "เหมาะสำหรับป้ายโฆษณาขนาดใหญ่พิเศษ", popular: false },
];

const materials = [
  {
    name: "ไวนิลกันแสง (Frontlit)",
    sub: "หลังด่านพลังแสง",
  ...
  {
    name: "ไวนิลกันแสง (Frontlit)",
    sub: "หลังขาว มาตรฐานนิยม",
    img: "bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a]",
    tag: null,
  },
  {
    name: "ไวนิลกันแสง (Frontlit)",
    sub: "เงาหนาพิเศษ พรีเมียม",
    img: "bg-gradient-to-br from-[#1a2030] to-[#0d1220]",
    tag: "พรีเมียม",
  },
  {
    name: "ไวนิลกันแสง (Frontlit)",
    sub: "ไม่ด้กระจกของเพลม",
    img: "bg-gradient-to-br from-[#2a2020] to-[#1a1010]",
    tag: null,
  },
  {
    name: "ไวนิลโปร่งแสง (Backlit)",
    sub: "ใช้ร่วมกับไฟ",
    img: "bg-gradient-to-br from-[#1a1a30] to-[#0d0d20]",
    tag: null,
  },
];

const edgeOptions = [
  { name: "ตัดปล่อย", sub: "ของงาน", icon: "✂" },
  { name: "พับเก็บงาน", sub: "", icon: "📐" },
  { name: "เจาะไก่", sub: "(รู 10 บาก)", icon: "⭕" },
  { name: "พับขอบสำหรับ", sub: "ร่อนห่อ", icon: "🔧" },
];

const portfolioItems = [
  { label: "ร้านอาหาร", color: "#FF7A00" },
  { label: "โปรโมชั่น", color: "#FF7A00" },
  { label: "Motor Expo", color: "#FF7A00" },
  { label: "Sale 80%", color: "#FF7A00" },
];
...
const faqs = [
  ...
  { q: "รับออกแบบหรือไม่?", a: "รับออกแบบครับ มีทีมกราฟิกช่วยออกแบบตามแนวคิดของคุณ มีค่าบริการเพิ่มเติม" },
  { q: "มีขั้นต่ำไหม?", a: "ไม่มีขั้นต่ำครับ สั่งได้ตั้งแต่ 1 ชิ้น" },
];

const features = [
  { icon: Droplets, label: "กันน้ำ", sub: "ทนฝน 100%" },
  { icon: Sun, label: "สีสด ไม่ซีดจาง", sub: "ทนแดดจัด" },
  { icon: Printer, label: "พิมพ์คมชัด", sub: "ความเอียดสูง" },
...
export default function VinylServicePage() {
    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-3 flex items-center gap-2 text-sm"
          ...
          <ChevronRight size={12} />
          <span style={{ color: "#FF7A00" }}>ป้ายไวนิล</span>
        </div>
      </div>
      ...
      >
        {/* 1. Next.js Image Component เป็นฉากหลัง */}
        <Image
          src="/images/hero-bg-vinyl.jpg" // <-- เช็คให้แน่ใจว่ารูปอยู่ในโฟลเดอร์ public/images/
          alt="Vinyl Service Background"
          fill
          priority
        ...
        {/* 2. Overlay เพื่อทำให้ข้อความอ่านง่ายขึ้น (ทับบนรูป) */}
        <div className="absolute inset-0 bg-[#050806]/70 z-0"></div>
        ...
        {/* 4. เนื้อหา (ต้องมี relative z-10 เพื่อให้อยู่เหนือรูปและ Overlay) */}
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <p className="text-base leading-relaxed mb-8 max-w-md text-gray-200">
                ป้ายไวนิลคุณภาพสูง สีสด คมชัด ทนแดด ทนฝน
                เหมาะสำหรับงานโฆษณา โปรโมชั่น และตกแต่งอาคาร
              </p>
      ...
      <section id="services" className="py-16 px-6 lg:px-8" style={{ background: "#050806" }}>
        <div className="max-w-7xl mx-auto">
            ...
            {sizes.map((s, i) => (
              ...
              >
                ...
                <div
                  ...
                  style={{
                    width: "60px",
                    height: `${Math.round(60 * (parseInt(s.h) / parseInt(s.w)) * 0.5)}px`,
                    minHeight: "24px",
                    maxHeight: "56px",
          ...
          <p className="text-xs mt-4" style={{ color: "rgba(167,176,192,0.6)" }}>
            * ขนาดสามารถปรับเปลี่ยนได้ตามพื้นที่และความต้องการ
          </p>
        </div>
      </section>

      {/* ────────────────────────────────────────────────────────────────
          3. MATERIAL + EDGE OPTIONS
      ─────────────────────────────────────────────────────────────────── */}
      <section className="py-16 px-6 lg:px-8" style={{ background: "#0E1310" }}>
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-3">
              {edgeOptions.map((e, i) => (
                ...
                >
                  ...
                  <div className="text-xs font-semibold text-white leading-tight">{e.name}</div>
                  {e.sub && (
                    <div className="text-xs" style={{ color: "#A7B0C0" }}>{e.sub}</div>
                  )}
                </div>
              ))}
            </div>
            ...
            >
              + เจาะรูตาไก่ รู่ะ 10 บาก &nbsp;|&nbsp; + เชือกแขวนป้าย เมตรละ 10 บาท
            </div>
          </motion.div>
        </div>
      </section>
      ...
      {/* ────────────────────────────────────────────────────────────────
          4. WHY CHOOSE US (TrustBar Component Integrated)
      ─────────────────────────────────────────────────────────────────── */}
      <section
        id="about"
        className="py-10"
      ...
      <section id="portfolio" className="py-16 px-6 lg:px-8" style={{ background: "#0E1310" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { gradient: "from-[#8B0000] to-[#2a0000]", title: "GRAND SALE 70%", sub: "ร้านอาหาร" },
              { gradient: "from-[#C45000] to-[#5a2000]", title: "เปิดแล้ว ลด 40%", sub: "โปรโมชั่น" },
              { gradient: "from-[#003087] to-[#001850]", title: "Motor Expo 2024", sub: "งาน Event" },
              { gradient: "from-[#4a3000] to-[#1a0d00]", title: "ลด 80%", sub: "ป้ายร้านค้า" },
            ].map((p, i) => (
              <motion.div
                key={i}
      ...
      {/* ────────────────────────────────────────────────────────────────
          6. WORKFLOW PROCESS (Process Component Integrated)
      ─────────────────────────────────────────────────────────────────── */}
      <section
        id="process"
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        ...
                        boxShadow:
                          "0 0 0 6px rgba(255,122,0,0.06), 0 8px 24px rgba(0,0,0,0.3)",
                      }}
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLElement).style.background =
                          "linear-gradient(135deg, #FF7A00, #E66A00)";
                        (e.currentTarget as HTMLElement).style.borderColor =
                          "#FF7A00";
                        (e.currentTarget as HTMLElement).style.boxShadow =
                          "0 0 0 8px rgba(255,122,0,0.12), 0 12px 32px rgba(255,122,0,0.3)";
                      }}
                      onMouseLeave={(e) => {
                        (e.currentTarget as HTMLElement).style.background =
                  ...
                  <div className="flex flex-col items-center flex-shrink-0">
                    ...
                    {i < processSteps.length - 1 && (
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(to bottom, rgba(255,122,0,0.4), transparent)",
                          minHeight: "48px",
                        }}
                      />
                    )}
      ...
      >
        ...
        >
          ...
          >
            สนใจทำป้ายไวนิล ขอใบเสนอราคาฟรี!
          </div>
          ...
          >
            พร้อมเสริมภาพลักษณ์
            <br />
            <span style={{ color: "#FF7A00" }}>ธุรกิจของคุณแล้วหรือยัง?</span>
          </h2>
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-10">
            {[
              ...
              { icon: Zap, label: "ผลิตไว", sub: "3-5 วันทำการ" },
