...
import {
  Plus, Minus, Check, Phone, MessageCircle, ArrowRight, ChevronRight, Menu, X, FileText, Calculator, CheckCircle2, Cog, Home, PackageCheck, Send, CheckCircle, Upload, Weight, Zap, Layers, Maximize2, Move, ShoppingBag } from "lucide-react";
...
const navLinks = [
  { label: "หน้าแรก", href: "/" },
  { label: "ประเภท PP Board", href: "#knowledge" },
...
const ppTypes = [
  {
    name: "ป้าย PP Board",
    desc: "แผ่น PP Board มาตรฐาน น้ำหนักเบา แข็งแรง พิมพ์สีสดคมชัด เหมาะสำหรับป้ายชั่วคราว งาน Event และการตกแต่งภายใน",
    image: "/images/ppboard/standard.jpg",
    highlights: [
      "น้ำหนักเบา พกพาและติดตั้งง่าย",
      "พิมพ์สีคมชัด 4 สี เต็มพื้นที่",
      "ราคาประหยัด คุ้มค่าสำหรับงานชั่วคราว",
    ],
    uses: [
      "ป้ายโปรโมชั่นหน้าร้านค้า",
      "ป้ายนิทรรศการและงาน Event",
      "ป้ายชั่วคราวในห้างสรรพสินค้า",
    ],
  },
  {
    name: "Standee",
    desc: "ป้าย Standee พร้อมขาตั้ง ติดตั้งง่ายไม่กี่วินาที เหมาะสำหรับงาน Booth สัมมนา และจุดประชาสัมพันธ์ทั่วไป",
    image: "/images/ppboard/standee.jpg",
    highlights: [
      "ประกอบง่าย",
      "ผลิตจาก PP Board คุณภาพดี แข็งแรง ทนทาน",
      "ออกแบบได้ไร้ขีดจำกัด: สามารถตัดตามรูปทรง (Die-cut) ได้ทุกรูปแบบตามที่ต้องการ",
    ],
    uses: [
      "งาน Booth และนิทรรศการ",
      "จุดต้อนรับและประชาสัมพันธ์",
      "ห้องประชุมและสัมมนา",
    ],
  },
  {
    name: "Cutout Standee",
    desc: "ป้าย Standee ไดคัทตามรูปทรง ตัดตามรูปบุคคล สินค้า หรือมาสคอต สร้างความโดดเด่นและดึงดูดสายตาได้อย่างมาก",
    image: "/images/ppboard/cutout.jpg",
    highlights: [
      "ไดคัทตามรูปทรงได้ทุกแบบ",
      "เพิ่มความน่าสนใจและดึงดูดสายตา",
      "เหมาะสำหรับมาสคอตและบุคคลจริง",
    ],
    uses: [
      "มาสคอตแบรนด์และสินค้า",
      "ป้ายบุคคลจริงสำหรับงาน Event",
      "ป้ายตกแต่งร้านค้าและโชว์รูม",
    ],
  },
];

const thicknessOptions = [
  { name: "3 มม.", sub: "ความหนา 3 mm บางเบา ประหยัด", desc: "เหมาะสำหรับป้ายชั่วคราว งานในระยะสั้น ราคาประหยัดที่สุด", image: "/images/ppboard/3mm.jpg" },
  { name: "4 มม.", sub: "ความหนา 4 mm มาตรฐาน แนะนำ", desc: "ความหนามาตรฐานที่นิยมที่สุด สมดุลระหว่างน้ำหนักและความแข็งแรง", image: "/images/ppboard/4mm.jpg" },
  { name: "5 มม.", sub: "ความหนา 5 mm หนาพิเศษ ทนทาน", desc: "เหมาะสำหรับป้ายที่ต้องการความแข็งแรงสูง ใช้งานระยะยาว กลางแจ้ง", image: "/images/ppboard/5mm.jpg" },
];

const ppSizes = [
  { size: "A2 (42 × 59.4 cm)", use: "ป้ายโปรโมชั่น ป้ายสินค้าในร้าน", note: "ขนาดยอดนิยม" },
  { size: "A1 (59.4 × 84.1 cm)", use: "ป้าย Standee ขนาดกลาง งาน Event", note: "แนะนำสำหรับ Standee" },
  { size: "A0 (84.1 × 118.9 cm)", use: "ป้ายขนาดใหญ่ นิทรรศการ Backdrop เล็ก", note: "-" },
  { size: "60 × 90 cm", use: "ป้าย Standee มาตรฐาน", note: "ขนาดนิยมสำหรับ Standee" },
  { size: "80 × 120 cm", use: "ป้าย Standee ขนาดใหญ่ โชว์รูม", note: "-" },
  { size: "Custom Size", use: "ทุกขนาดตามความต้องการของคุณ", note: "แจ้งขนาดได้เลย" },
];

const portfolioImages = [
  "/images/portfolio/ppboard-1.png",
  "/images/portfolio/ppboard-2.png",
  "/images/portfolio/ppboard-3.png",
  "/images/portfolio/ppboard-4.png",
];
...
const processSteps = [
  {
    ...
    desc: "แจ้งขนาด ความหนา จำนวน และไฟล์งานผ่าน LINE หรือแบบฟอร์มออนไลน์",
    time: "ภายใน 5 นาที",
  },
  {
    num: 2,
    icon: Calculator,
    title: "ประเมินราคา",
    desc: "ทีมงานประเมินราคาและส่งใบเสนอราคาพร้อมรายละเอียดครบถ้วน ภายใน 24 ชั่วโมง",
  ...
  },
  {
    ...
    desc: "ตรวจสอบและยืนยันแบบร่วมกันก่อนผลิตจริงทุกครั้ง ชำระผ่านโอน/พร้อมเพย์",
    time: "ขั้นตอนง่าย",
  },
  {
    num: 4,
    icon: Cog,
    title: "ผลิตงาน",
    desc: "พิมพ์และประกอบโดยช่างผู้เชี่ยวชาญ ตรวจสอบคุณภาพก่อนส่งทุกชิ้น",
    time: "1–3 วันทำการ",
  },
  {
    num: 5,
    ...
    desc: "จัดส่งอย่างระมัดระวัง แพ็คป้องกันการงอ พร้อมแจ้งเลขพัสดุทุกออเดอร์",
    time: "ทั่วประเทศ",
  },
];
...
const faqs = [
  ...
  { q: "PP Board ใช้งานกลางแจ้งได้ไหม?", a: "ได้ครับ PP Board ทนความชื้นและน้ำได้ดี แต่ไม่ทนแดดจัดในระยะยาว หากใช้กลางแจ้งแนะนำความหนา 5–8 มม. และหลีกเลี่ยงแดดตรง" },
  { q: "Standee มีขาตั้งให้ด้วยไหม?", a: "ขึ้นอยู่กับแพ็คเกจที่สั่งครับ มีทั้งแบบแผ่น PP Board อย่างเดียว และแบบพร้อมโครง X-Stand หรือ L-Stand สอบถามทีมงานเพื่อเลือกที่เหมาะสม" },
  { q: "มีขั้นต่ำไหม?", a: "ไม่มีขั้นต่ำครับ สั่งได้ตั้งแต่ 1 ชิ้น" },
];
...
const ppFeatures = [
  { icon: Weight, title: "น้ำหนักเบา", desc: "พกพา ติดตั้งง่าย" },
  { icon: Zap, title: "ประกอบรวดเร็ว", desc: "พร้อมใช้ในไม่กี่นาที" },
  { icon: Layers, title: "หลายความหนา", desc: "3 / 5 / 8 มม." },
  { icon: Maximize2, title: "ทุกขนาด", desc: "Custom ได้ตามต้องการ" },
];
...
export default function PPBoardLandingPage() {
    ...
    <div className="brand-interior brand-service-detail min-h-screen font-['Prompt',sans-serif] text-white bg-[#050806]">
      ...
      <div className="pt-[70px] bg-[#050806] border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-3 flex items-center gap-2 text-sm text-[#A7B0C0]">
          ...
          <ChevronRight size={14} />
          <span className="text-[#FF7A00]">PP Board / Standee</span>
        </div>
      </div>

      {/* ── 1. HERO SECTION ── */}
      <section id="hero" className="relative overflow-hidden flex items-center min-h-[560px] bg-[#050806]">
        <Image src="/images/services/Hero ppboard BG.jpg" alt="PP Board Standee" fill priority className="object-cover object-center z-0" />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full pt-16 pb-24">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="max-w-3xl">
            ...
            <h1 className="font-['Kanit'] font-extrabold text-5xl lg:text-7xl mb-6 leading-tight text-white">
              PP Board
              <span className="block text-[#FF7A00]">/ Standee</span>
            </h1>

            <p className="text-base text-gray-300 max-w-xl mb-10 leading-relaxed">
              ป้าย PP Board น้ำหนักเบา ประกอบง่าย เหมาะสำหรับงาน Event ป้ายชั่วคราว นิทรรศการ และตกแต่งร้านค้า พิมพ์สีสดคมชัดทุกชิ้นงาน
            </p>
      ...
      {/* ── 2. PP BOARD KNOWLEDGE ── */}
      <section id="knowledge" className="py-24 bg-[#0E1310]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-['Kanit'] font-bold text-white mb-6">ทำความรู้จัก PP Board และ Standee</h2>

            <div className="bg-[#141A24] border border-white/5 p-6 rounded-2xl mb-10 shadow-lg">
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                <strong className="text-[#FF7A00]">PP Board (Polypropylene Board)</strong> คือ แผ่นพลาสติก Polypropylene ที่มีโครงสร้างเป็นรังผึ้งภายใน ทำให้น้ำหนักเบา แข็งแรง ทนความชื้น นิยมใช้เป็นวัสดุสำหรับป้ายโฆษณา Standee และงาน Event ที่ต้องการความสะดวกในการพกพาและติดตั้ง
              </p>
            </div>

            <p className="text-gray-400 mb-8">เลือกประเภทที่เหมาะกับงานของคุณ</p>

            <div className="grid lg:grid-cols-3 gap-8">
              {ppTypes.map((item, idx) => (
      ...
      <section className="py-24 bg-[#050806]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-['Kanit'] font-bold text-white mb-2">ความหนาของ PP Board</h2>
            <p className="text-gray-400">เลือกความหนาให้เหมาะกับการใช้งานและงบประมาณของคุณ</p>
          </div>
      ...
      <section id="services" className="py-24 bg-[#0E1310]">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-['Kanit'] font-bold mb-4">ขนาด PP Board และ Standee</h2>
            <p className="text-gray-400">ขนาดมาตรฐานที่นิยมสั่งผลิต — หรือแจ้งขนาดที่ต้องการได้เลย</p>
          </div>
      ...
      <section id="legacy-portfolio" className="py-24 bg-[#050806]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-['Kanit'] font-bold text-white mb-2">ตัวอย่างผลงาน PP Board / Standee</h2>
      ...
      <section id="legacy-process" className="py-24 lg:py-32 px-6 lg:px-8" style={{ background: "#0B0F19" }}>
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center mb-20">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-base">ขั้นตอนที่ออกแบบมาเพื่อความสะดวกของคุณ ไม่ต้องเดินทาง ไม่ต้องนัดหมาย</p>
          </motion.div>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <input {...register("width")} placeholder="เช่น 60" className="w-full px-4 py-3 rounded-lg text-white text-sm outline-none bg-[#0d1220] border border-white/10" />
                      </div>
                      <div>
                        <label className="block text-xs text-gray-400 mb-2 font-medium tracking-wide">ขนาดสูง (cm)</label>
                        <input {...register("height")} placeholder="เช่น 90" className="w-full px-4 py-3 rounded-lg text-white text-sm outline-none bg-[#0d1220] border border-white/10" />
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <textarea {...register("details")} rows={4} placeholder="รายละเอียดงาน ความหนา PP Board ต้องการโครงตั้งหรือไม่ หรือข้อมูลเพิ่มเติม..." className="w-full px-4 py-3 rounded-lg text-white text-sm outline-none resize-y bg-[#0d1220] border border-white/10" />
                    </div>
                    <div>
      ...
      {/* ── 9. FOOTER ── */}
      <SharedServiceSections serviceKey="ppboard" />
      <GlobalFooter />
    </div>
  );
}
