...
import {
  ChevronRight, ChevronLeft, Plus, Minus, Check, Phone, MessageCircle, ArrowRight, Menu, X, Shield, Zap, Truck, Home, Droplets, Sun, Scissors, Award, ShoppingCart, UserCheck, PackageCheck, FileText, Calculator, CheckCircle2, Cog, Layers, Eye } from "lucide-react";
