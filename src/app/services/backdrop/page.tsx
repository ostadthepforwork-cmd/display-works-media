...
const backdropTypes = [
  { 
    ...
    highlights: [
      ...
      "ถอดซักทำความสะอาดได้ น้ำหนักเบา พกพาใส่กระเป๋าง่าย"
    ],
    uses: [
      "ฉากหลังถ่ายรูปงานแต่งงาน (Wedding Backdrop)",
      "งานแถลงข่าว งานเปิดตัวสินค้า",
  ...
  { 
    ...
    highlights: [
      ...
      "สามารถเปลี่ยนแผ่นพิมพ์งานใหม่มาแปะที่โครงเดิมได้ตลอด"
    ],
    uses: [
      "ออกบูธแสดงสินค้าตามศูนย์ประชุม (Exhibition)",
      "ฉากหลังสำหรับสัมมนาทางวิชาการ",
  ...
  { 
    ...
    highlights: [
      ...
      "สามารถไดคัท (Die-cut) ทำเลเยอร์ 2-3 ชั้นให้ดูมีมิติได้"
    ],
    uses: [
      "ฉากหลังเวทีคอนเสิร์ต หรืองานกิจกรรมกลางแจ้ง",
      "ซุ้มประตูทางเข้างาน (Archway)",
      "แบ็คดรอปถ่ายรูปหน้างานกาล่าขนาดใหญ่"
    ]
  },
];

const structureOptions = [
  { name: "โครงหน้าตรง (Straight)", sub: "รูปทรงคลาสสิก จัดวางง่าย เข้าได้กับทุกพื้นที่", image: "/images/edges/straight.jpg" },
  { name: "โครงหน้าโค้ง (Curved)", sub: "ดีไซน์โอบล้อม ดูมีมิติ โดดเด่นเวลาถ่ายรูป", image: "/images/edges/curved.jpg" },
  { name: "เพิ่มไฟ LED (Light Box)", sub: "แบ็คดรอปตู้ไฟ สว่างโดดเด่นสะกดทุกสายตา", image: "/images/edges/lightbox.jpg" },
];

const sizes = [
  { size: "2.4 × 2.3 เมตร", use: "บูธขนาดเล็ก งานอีเวนต์ที่มีพื้นที่จำกัด", note: "พกพาสะดวกที่สุด" },
  { size: "3.0 × 2.3 เมตร", use: "งานออกบูธมาตรฐาน ฉากหลังสัมมนา", note: "ขนาดยอดนิยม" },
  { size: "4.0 × 2.3 เมตร", use: "ฉากถ่ายรูปงานแต่งงาน งานแถลงข่าว", note: "เหมาะสำหรับกรุ๊ปถ่ายรูป 5-8 คน" },
  { size: "6.0 × 3.0 เมตร", use: "ฉากหลังเวที (Stage Backdrop) งานสเกลใหญ่", note: "ส่วนใหญ่ใช้โครงทรัส/ไม้" },
  { size: "Custom Size", use: "สั่งทำขนาดและรูปทรงพิเศษตามหน้างานจริง", note: "โปรดสอบถามทีมประเมินราคา" },
];

const portfolioImages = [
  "/images/portfolio/backdrop-1.png",
  "/images/portfolio/backdrop-2.png",
  "/images/portfolio/backdrop-3.png",
  "/images/portfolio/backdrop-4.png",
];
...
const processSteps = [
  {
    ...
    desc: "แจ้งขนาด ประเภทแบ็คดรอปที่ต้องการ ผ่าน LINE หรือฟอร์ม ง่าย ไม่ต้องเดินทาง",
    time: "ภายใน 5 นาที",
  },
  {
    num: 2,
  ...
  },
  {
    ...
    icon: Cog,
    title: "ผลิตงาน",
    desc: "ดำเนินการผลิต งานพิมพ์คมชัด ตรวจสอบโครงสร้างก่อนจัดส่ง มั่นใจในคุณภาพ",
    time: "3–5 วันทำการ",
  },
  {
    num: 5,
    ...
    desc: "มีบริการจัดส่งทั่วประเทศ พร้อมทีมงานติดตั้งสำหรับงานสเกลใหญ่ (หรือแพ็คกระเป๋าส่งพัสดุ)",
    time: "ทั่วประเทศ",
  },
];

const faqs = [
  { q: "ใช้เวลาผลิตกี่วัน?", a: "โดยปกติแบ็คดรอปจะใช้เวลาผลิต 3-5 วันทำการ หลังจากคอนเฟิร์มแบบ หากมีงานด่วนสามารถแจ้งล่วงหน้าได้ครับ" },
  { q: "ประกอบติดตั้งเองได้ไหม?", a: "ได้แน่นอนครับ สำหรับแบ็คดรอปผ้าและ Pop-up ถูกออกแบบมาให้ประกอบง่าย ใช้เวลาไม่ถึง 10 นาที (ส่วนโครงไม้และโครงทรัส ทางเรามีบริการทีมช่างติดตั้งให้หน้างานครับ)" },
  { q: "มีโครงอยู่แล้ว สั่งแค่ผ้าหรือแผ่นพิมพ์ได้ไหม?", a: "สามารถทำได้ครับ เพียงแจ้งขนาดโครงเดิมที่มีอยู่ ทางเรายินดีรับผลิตเฉพาะส่วนงานพิมพ์เพื่อประหยัดงบประมาณ" },
  { q: "รับออกแบบกราฟิกแบ็คดรอปไหม?", a: "รับออกแบบครับ เรามีทีมกราฟิกช่วยออกแบบและจัดวางคอมโพสิชันให้เหมาะสมกับการถ่ายรูปมากที่สุด" },
];

const serviceLinks = [
  "แบ็คดรอปผ้า",
  "แบ็คดรอป Pop-up",
  "แบ็คดรอปโครงไม้ / โครงทรัส",
  "Standee / Roll Up",
  "ป้ายไวนิล",
];
...
const backdropFeatures = [
  { icon: Layers, title: "ประกอบง่าย", desc: "กางและเก็บรวดเร็ว" },
  { icon: Printer, title: "ภาพคมชัด", desc: "High Resolution" },
  { icon: PackageCheck, title: "พกพาสะดวก", desc: "มีกระเป๋าจัดเก็บ" },
  { icon: Box, title: "โครงสร้างทนทาน", desc: "แข็งแรง ทรงตัวดี" },
];
...
export default function BackdropLandingPage() {
    ...
    <div className="min-h-screen font-['Prompt',sans-serif] text-white bg-[#050816]">
      ...
      <div className="pt-[70px] bg-[#050816] border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-3 flex items-center gap-2 text-sm text-[#A7B0C0]">
          ...
          <ChevronRight size={14} />
          <span className="text-[#FF7A00]">แบ็คดรอป (Backdrop)</span>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full pt-16 pb-24"> 
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }} className="max-w-3xl">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold mb-6 border border-[#FF7A00]/30 text-[#FF7A00] bg-transparent">
              บริการออกแบบและผลิตแบ็คดรอป
            </div>
            
            <h1 className="font-['Kanit'] font-extrabold text-5xl lg:text-7xl mb-2 leading-tight text-white">แบ็คดรอป</h1>
            <h1 className="font-['Kanit'] font-extrabold text-5xl lg:text-7xl mb-6 text-[#FF7A00] leading-tight">ฉากหลังจัดงาน</h1>
            
            <p className="text-base text-gray-300 max-w-xl mb-10 leading-relaxed">
              ผลิตแบ็คดรอปสำหรับงานอีเวนต์ นิทรรศการ และงานแต่งงาน ภาพคมชัด โครงสร้างแข็งแรง ติดตั้งง่าย สะกดทุกสายตาให้งานคุณโดดเด่นยิ่งขึ้น
            </p>
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#141A24] border border-white/5 p-6 rounded-2xl mb-10 shadow-lg">
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
                <strong className="text-[#FF7A00]">แบ็คดรอป (Backdrop)</strong> หรือฉากหลัง เป็นหัวใจสำคัญของงานจัดแสดงที่ช่วยสื่อสารตัวตนของแบรนด์ เป็นจุดดึงดูดสายตา และจุดถ่ายภาพยอดฮิต (Photo Backdrop) มีหลายรูปแบบโครงสร้างและวัสดุให้เลือกใช้งานตามความเหมาะสมของสถานที่และจุดประสงค์
              </p>
            </div>

            <p className="text-gray-400 mb-8">เลือกใช้งานให้เหมาะกับประเภทงานของคุณ</p>

            <div className="grid lg:grid-cols-3 gap-8">
              {backdropTypes.map((item, idx) => (
      ...
      <section className="py-24 bg-[#050816]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-['Kanit'] font-bold text-white mb-2">รูปแบบและรูปทรงของแบ็คดรอป</h2>
            <p className="text-gray-400">เลือกลักษณะโครงสร้างที่เข้ากับพื้นที่งานจัดแสดงของคุณ</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {structureOptions.map((opt, i) => (
      ...
      <section id="services" className="py-24 bg-[#0B1220]">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-['Kanit'] font-bold mb-4">ขนาดแบ็คดรอปยอดฮิต</h2>
            <p className="text-gray-400">ขนาดมาตรฐานที่ลูกค้านิยมเลือกใช้สำหรับงานอีเวนต์</p>
          </div>
          ...
          <p className="mt-6 text-center text-xs text-gray-500 tracking-widest">* สามารถสั่งผลิตโครงสร้างแบบ Custom Size ได้ทุกรูปแบบตามพื้นที่หน้างาน</p>
        </div>
      </section>
      ...
      <section id="portfolio" className="py-24 bg-[#050816]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-['Kanit'] font-bold text-white mb-2">ตัวอย่างผลงานแบ็คดรอป</h2>
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div>
                        ...
                        <input {...register("width")} placeholder="เช่น 300" className="w-full px-4 py-3 rounded-lg text-white text-sm outline-none bg-[#0d1220] border border-white/10 focus:border-[#FF7A00]/50" />
                      </div>
                      <div>
                        <label className="block text-xs text-gray-400 mb-2 font-medium tracking-wide">ขนาดสูง (cm)</label>
                        <input {...register("height")} placeholder="เช่น 230" className="w-full px-4 py-3 rounded-lg text-white text-sm outline-none bg-[#0d1220] border border-white/10 focus:border-[#FF7A00]/50" />
                      </div>
                      <div>
                        <label className="block text-xs text-gray-400 mb-2 font-medium tracking-wide">จำนวน (ชิ้น/ชุด)</label>
                      ...
                      <div>
                        <label className="block text-xs text-gray-400 mb-2 font-medium tracking-wide">วันที่ต้องการใช้งาน</label>
                    ...
                    <div>
                      ...
                      <textarea {...register("details")} rows={4} placeholder="รายละเอียดงาน ประเภทโครงสร้างที่ต้องการ หรือสิ่งที่อยากให้เราทราบเพิ่มเติม..." className="w-full px-4 py-3 rounded-lg text-white text-sm outline-none resize-y bg-[#0d1220] border border-white/10 focus:border-[#FF7A00]/50" />
                    </div>

                    {/* File Upload */}
                    <div>
                      <label className="block text-xs text-gray-400 mb-2 font-medium tracking-wide">แนบไฟล์แบบ (ถ้ามี)</label>
      ...
      <footer id="contact" className="bg-[#080B13] border-t border-white/5">
        <div className="py-8 px-6 lg:px-8 border-b border-white/5">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <p className="font-['Kanit'] font-bold text-white text-lg">พร้อมเริ่มผลิตแบ็คดรอปแล้วหรือยัง?</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-14 pb-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-sm leading-relaxed mb-6 text-gray-400">บริการสั่งผลิตแบ็คดรอป ป้าย และอุปกรณ์ออกบูธครบวงจร ง่าย เร็ว มืออาชีพ ส่งทั่วประเทศ</p>
