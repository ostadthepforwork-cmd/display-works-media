...
import {
  Plus, Minus, Check, Phone, MessageCircle, ArrowRight, ChevronRight, Sun, Printer, Award, ShoppingCart, UserCheck, PackageCheck, Menu, X, FileText, Calculator, CheckCircle2, Cog, Scissors, Layers, CircleDot, Box, Home, Droplets, Zap, Truck, Info, Lock, MapPin, Mail, Send, CheckCircle, Upload, Sparkles, AlertCircle } from "lucide-react";
